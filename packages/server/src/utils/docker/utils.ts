...
const checkDockerResourceHealth = async (
	...
	// The edge proxy can run as a standalone container or a swarm service
	try {
...
export const checkWebServerHealth = async (
	...
	return {
		provider,
		...(await checkDockerResourceHealth(getWebServerResourceName(provider))),
	};
};
